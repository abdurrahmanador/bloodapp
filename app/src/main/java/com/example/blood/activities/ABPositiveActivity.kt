...
class ABPositiveActivity:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.setTitle("AB+ Donor")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ab_positive)
    ...
    private fun ABPositiveList() {
        db.collection("users").whereEqualTo("bloodGroup","AB+")
        ...
        myAdapter.setClickListener(object : MyAdapter.ClickListener{
            override fun onItemClick(position: Int) {
                val intent= Intent(this@ABPositiveActivity,DonorDetailsActivity::class.java)
