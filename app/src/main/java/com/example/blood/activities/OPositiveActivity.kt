...
class OPositiveActivity:AppCompatActivity() {    private lateinit var recyclerView: RecyclerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.setTitle("O+ Donor")
    ...
    private fun OPositiveList() {
        db.collection("users").whereEqualTo("bloodGroup","O+")
        ...
        myAdapter.setClickListener(object : MyAdapter.ClickListener{
            override fun onItemClick(position: Int) {
                val intent= Intent(this@OPositiveActivity,DonorDetailsActivity::class.java)
